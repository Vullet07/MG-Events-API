...
namespace Data.Migrations
{
    ...
    [Migration("20260402115615_EmailConfirmationGenderAndResolvedPins")]
    partial class EmailConfirmationGenderAndResolvedPins
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.PinVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Models.PostVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Models.TeacherRegistrationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Models.ForumPost", b =>
                {
                    b.HasOne("Data.Models.ForumPost", "ParentPost")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Data.Models.PostVote", b =>
                {
                    b.HasOne("Data.Models.ForumPost", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.Models.Report", b =>
                {
                    ...
                    b.HasOne("Data.Models.User", "ResolvedBy")
                        .WithMany()
                        .HasForeignKey("ResolvedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Data.Models.TeacherRegistrationRequest", b =>
                {
                    b.HasOne("Data.Models.User", "ReviewedBy")
                        .WithMany()
